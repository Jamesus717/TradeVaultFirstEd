        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-2xl shadow-black/20 backdrop-blur">
          ...
          <div className="space-y-8 p-6 sm:p-8">
              ...
              <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border border-emerald-300/20 bg-emerald-400/10 text-2xl font-semibold text-emerald-200"
                    disabled={saving}
                  >
                    {profile?.avatar_url ? (
                      <Image
            ...
            <section className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-5">
              ...
              {resetMessage ? <p className="mt-3 text-sm text-emerald-200">{resetMessage}</p> : null}
              {!supabase ? (
